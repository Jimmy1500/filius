...
class Optimization{
    ...
    public:
        ...
        void getGradient (double*, size_t, RateModel * model, RateInstrument *, size_t, double*);
        double loss_function (RateInstrument * instruments, size_t num_instrs, double * weights, size_t order = 2);
        double avg_loss (G2PP * model, RateInstrument * instruments, size_t num_intrs, double * weights, int ntrials, size_t order = 2);
};
#endif
